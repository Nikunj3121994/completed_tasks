...
#from protokol_bookmarks.urls import urlpatterns as bookmarks_pattern
admin.autodiscover()
...
urlpatterns = patterns('',
    url(r'^api/', include('angular_rest_bookmarks.api.urls')),
    url(r'^admin/', include(admin.site.urls)),
    url(r'^(?P<template_name>\w+)$', SimpleStaticView.as_view(), name='example'),
    # url(r'^$', TemplateView.as_view(template_name='index.html')),
    # url(r'^protokol_bookmarks/', include('protokol_bookmarks.urls', namespace='protokol_bookmarks')),
    #url(r'^protokol_bookmarks/api/', include('protokol_bookmarks.api.urls', namespace='bookmarks_api')),
)
