...
urlpatterns = patterns('',
                       url(r'^$', AuthTemplateView.as_view(
...
if 'angular_rest_bookmarks' in settings.INSTALLED_APPS:
    urlpatterns += patterns('',
                            url(r'^bookmarks/', include('angular_rest_bookmarks.urls',
                                                        namespace='rest_bookmarks')),
                            )
...
if 'my_files_storage' in settings.INSTALLED_APPS:
    urlpatterns += patterns('',
                            url(r'^my_files_storage/', include('my_files_storage.urls',
                                                               namespace='my_files_storage')),
                            )
